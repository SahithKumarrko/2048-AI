...
def prepare_str(direction,current_color):
    ...
    return [rcolor],rcolor+move

print("Starting")
# cells = [[0,0,2,8],[0,0,16,8],[2,2,4,32],[0,0,0,8]]
cells = [[0,2,4,64],[0,0,2,8],[0,0,0,2],[0,0,0,2]]
# cells= [[2,16,8,2],[16,4,2,0],[2,0,0,0],[2,0,0,0]]
board = Board()
board.cells = cells[:]
ai = AI()
print("Completed intializing")
next_move = ai.nextMove(board,6)
cur_color = []
cur_color,move_str = prepare_str(next_move,cur_color)
print(move_str)